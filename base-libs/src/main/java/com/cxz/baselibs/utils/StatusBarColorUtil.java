 ...
 * @author chenxz
 * @date 2018/10/11
 * @desc 修改状态栏字体图标的颜色，黑色或者白色
 */
public class StatusBarColorUtil {

    private static int mStatusBarType = StatusBarColorUtil.STATUSBAR_TYPE_DEFAULT;
    ...
    private static boolean isMIUICustomStatusBarLightModeImpl() {
        if (RomUtil.isMIUIV9() && Build.VERSION.SDK_INT < Build.VERSION_CODES.M) {
            return true;
        }
